...
<link href="<%=request.getContextPath()%>/resources/css/add-restaurant.css" rel="stylesheet">
...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <form:form id="editRestaurantForm" action="${pageContext.request.contextPath}/restaurants/update/${restaurant.restaurantId}" method="post" modelAttribute="restaurant">

                <!-- Two-column row for Restaurant Name and Address -->
                <div class="form-row">
                    <div class="form-group mb-2">
                        <label for="restaurantName">Restaurant Name</label>
                        <form:input path="restaurantName" class="form-control" placeholder="Enter restaurant name" required="true"/>
                        <small id="nameError" class="error-message text-danger"></small>
                    </div>

                    <div class="form-group mb-2">
                        <label for="restaurantAddress">Address</label>
                        <form:input path="restaurantAddress" class="form-control" placeholder="Enter address" required="true"/>
                ...
                <div class="form-row">
                    <div class="form-group mb-2">
                        ...
                        <form:input path="restaurantPhoneNumber" class="form-control" placeholder="Enter phone number" />
                        <small id="phoneError" class="error-message text-danger"></small>
                    </div>

                    <div class="form-group mb-2">
                        <label for="restaurantRating">Rating</label>
                        <form:input path="restaurantRating" class="form-control" placeholder="Enter rating (1-5)" />
                ...
                <div class="form-row">
                    <div class="form-group mb-2">
                        ...
                        <form:input path="restaurantLocation" class="form-control" placeholder="Enter location" required="true"/>
                        <small id="locationError" class="error-message text-danger"></small>
                    </div>

                    <div class="form-group mb-2">
                        <label for="restaurantCategory">Category</label>
                        <form:select path="restaurantCategory" class="form-control" required="true">
                ...
                <div class="form-row">
                    <div class="form-group mb-2" style="flex: 100%;">
                        ...
                        <form:input path="restaurantImageUrl" class="form-control" placeholder="Enter image URL" />
                ...
                <div class="form-row">
                    <div class="form-group mb-2" style="flex: 100%;">
                        ...
                        <form:textarea path="restaurantOverview" class="form-control" rows="4" placeholder="Enter a brief overview about the restaurant" />
                ...
                <div class="form-row">
                    <div class="form-group mb-2" style="flex: 100%;">
                        ...
                        <form:input path="restaurantTimings" class="form-control" placeholder="Enter restaurant timings (e.g., 9 AM - 9 PM)" required="true" />
